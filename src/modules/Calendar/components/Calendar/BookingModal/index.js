...
const BookingModal = props => (
  <BaseModal className='booking-modal' ref={props.modalRef} {...props}>
    <p className='title'>O Masă Caldă</p>
    <p className='info'>
      Pe adresa de mail pe care ne-o dai, îți vom trimite mesajul de confirmare
      a rezervării. Dacă intervine ceva, aveți posibilitatea renunțării la
      rezervare, ca noi să avem timp să găsim echipă înlocuitoare. Mulțumim!
    </p>
      ...
      <div className='form-fields'>
        ...
        <div className='row'>
          <div className='col-xs-12'>
            <CButton type='submit' text='Programează-te' size='med' />
          </div>
        </div>
      </div>
    </form>
